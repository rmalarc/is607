...
* Given any two diagnosis a and b, a is related to b if the frequency of a is greater than the frequency of b
...
WITH a
    ,b
    , TOFLOAT(a.frequency + b.frequency) AS total_frequency
    , TOFLOAT(count(*)) AS frequency 
WHERE a.frequency > b.frequency AND frequency > 200
CREATE (a)
                -[:RELATED {mentions:frequency
                            ,mentions_probability: frequency/(total_frequency-frequency)}]->
                (b);
...
## Get Diagnosis Related by at least 10%
